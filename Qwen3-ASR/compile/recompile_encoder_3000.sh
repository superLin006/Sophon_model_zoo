...
ONNX_DIR="./tmp/onnx_enc3000"  # 导出: python export_encoder_onnx.py（离线 3000 帧）/ --num_mel_frames 500 --out_dir ./tmp/onnx_enc_w500（流式窗口）
...
model_tool --combine \
  ...
  -o "${OUT_DIR}/qwen3_asr_encoder_3000_F16.bmodel"

echo ""
echo "Done: ${OUT_DIR}/qwen3_asr_encoder_3000_F16.bmodel"
